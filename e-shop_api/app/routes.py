...
from endpoints.users import users_get, users_login_get, users_post
from endpoints.shops import shops_get, shops_id_get, shops_post, shops_id_products_get
from endpoints.products import products_get, products_id_get, products_post, products_shops_get, products_shops_put
from endpoints.basket import baskets_get, baskets_id_get, baskets_post, baskets_id_products_put, baskets_id_products_get
...
def setup_routes(app: Application):
    ...
    app.router.add_get('/users/{login}', users_login_get, name='user_info')
    ...
    app.router.add_put('/products/{id}/shops', products_shops_put, name='add_shop_to_product')

    app.router.add_get('/baskets', baskets_get, name='baskets')
    app.router.add_get('/baskets/{id}', baskets_id_get, name='basket_info')
    app.router.add_post('/baskets', baskets_post, name='baskets_create')
    app.router.add_get('/baskets/{id}/products', baskets_id_products_get, name='basket_products_info')
    app.router.add_put('/baskets/{id}/products', baskets_id_products_put, name='add_product_to_basket')
